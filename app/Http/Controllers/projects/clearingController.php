...
class clearingController extends Controller
{
    ...
    public function approval(Clearing $id)
    {
        ...
        return redirect()->back()->with(['success'=>'Se ha aprobado el proyecto correctamente','sudmenu'=>14]);
    }
    public function not_approval(Clearing $id)
    {
        ...
        return redirect()->back()->with(['success'=>'Se ha desaprobado el proyecto correctamente','sudmenu'=>14]);
    }
