...
class RoutesProjectController extends Controller
{
    ...
    public function approval(Routes $id)
    {
        ...
        return redirect()->back()->with(['success'=>'Se ha aprobado el proyecto correctamente','sudmenu' => 15]);
    }
    public function not_approval(Routes $id)
    {
        ...
        return redirect()->back()->with(['success'=>'Se ha desaprobado el proyecto correctamente','sudmenu' => 15]);
    }
}