...
class bonu extends Model
{
    ...
    protected $fillable = ['start_date','end_date','total_pay_admin','total_pay_24_7','total_pay_drive','total_pay','approve_id','status','total_employees','responsable_id','date','total_pay_discount'];
