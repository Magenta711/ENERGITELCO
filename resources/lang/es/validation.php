...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'file' => 'archivo',
        'approval_emails' => 'correo de documentos aprobados',
        'emails_before_approval' => 'correo documento sin aprobar',
        'name_responsable' => 'nombre del responsable',
        'email_responsable' => 'correo del responsable',
        'tel_responsable' => 'teléfono del responsable',
        'name_app' => 'nombre del sistema',
        'company' => 'nombre de la empresa',
        'age' => 'edad',
        'marital_status' => 'estado civil',
        'position_aspires_id' => 'cargo al que aspira',
        'observations' => 'observaciones',
        'name_document' => 'nombre del documento',
        'type_billboard' => 'tipo de cartelera',
        'document' => 'documento',
        'affair' => 'asunto',
