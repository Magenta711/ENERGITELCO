                        ...
                        <tbody>
                            ...
                            @endphp
                                @if ($num = $user->numAssigment())
                                    @foreach ($user->assigment_kits as $item)
                                        @if ($item->status == 1)
                                            @php
                                                $i++;
                                            @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group ms-2">
                                                    <a href="{{ route('kits_review_show', $user->id) }}"
                                                        class="btn btn-sm btn-primary" value="Ver">Ver</a>
                                                    <a href="{{ route('review_personal', $user->id) }}"
                                                        class="btn btn-sm btn-success" value="Editar">Revisar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endif
