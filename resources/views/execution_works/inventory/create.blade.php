...
<section class="content-header">
    <h1>
        Crear herramientas <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">Crear herramientas</li>
    </ol>
</section>
{{-- Content main --}}
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Crear herramienta</h3>
                    <div class="box-tools">
                        <a href="{{route('inventory_tools')}}" class="btn btn-sm btn-primary btn-send">Volver</a>
                    </div>
                </div>
                <form action="{{ route('inventory_tools_store') }}" method="POST">
                    @csrf
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
