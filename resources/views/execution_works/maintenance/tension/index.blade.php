...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Media y Baja Tensión</li>
...
<SECTION class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Lista de mantenimientos de Media, baja Tensión</h3>
            <div class="box-tools">
                    <a href="{{route('strain_create', $id->id)}}" class="btn btn-sm btn-success btn-send">Crear</a>
                            ...
                            @foreach ($general as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('strain_edit', $item->id) }}" class="btn btn-warning">Editar</a>
                                        <a href="{{ route('strain_photos',[$item->campus->id,$item->id]) }}" class="btn btn-primary">Fotos</a>
                                        <a href="{{ route('strain_export', $item->id) }}" class="btn btn-danger">Exportar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
