...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <form action="{{ route('strain_store', $id->id) }}" method="POST">
                @method('POST')
                @csrf
                <div class="box-body">
                    ...
                    <div class="content">
                        <div class="panel box box-success">
                            ...
                            <div id="collapseZero" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.tension.includes.dates_generls')
                                </div>
                            </div>
                        </div>
                        <div class="panel box box-info">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.tension.includes.check_list')
                                </div>
                            </div>
                        </div>
