...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{ route('smu_store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" id="id_sede" name="id_sede" value="{{ old('id_sede') }}" class="form-control">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="OT">C{{ 'o' }}digo OT</label>
                            <input type="text" id="OT" name="OT" value="{{ old('OT') }}" class="form-control">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="site_name" name="site_name" value="{{ old('site_name') }}" class="form-control">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="locate" name="locate" value="{{ old('locate') }}" class="form-control">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="structure">Estructura</label>
                            <input type="text" id="structure" name="structure" value="{{ old('structure') }}" class="form-control">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="plants_amount">Cantidad plantas</label>
                            <input type="number" id="plants_amount" name="plants_amount" value="{{ old('plants_amount') }}" class="form-control">
                        </div>
                    </div>
                </div>
