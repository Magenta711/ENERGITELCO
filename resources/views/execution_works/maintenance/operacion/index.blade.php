...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Operación y Mantenimiento</li>
...
<SECTION class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Lista de mantenimientos de Operación y Mantenimientos</h3>
            <div class="box-tools">
                    <a href="{{route('operation_create', $id->id)}}" class="btn btn-sm btn-success btn-send">Crear</a>
                    ...
                    <table id="table_index" class="table table-striped table-bordered" data-page-length='15'>
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Empresa Colaboradora</th>
                            ...
                            @foreach ($general as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('operation_edit', $item->id) }}" class="btn btn-warning">Editar</a>
                                        <a href="{{ route('operation_photos',[$item->campus->id,$item->id]) }}" class="btn btn-primary">Fotos</a>
                                        <a href="{{ route('operation_export', $item->id) }}" class="btn btn-danger">Exportar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
