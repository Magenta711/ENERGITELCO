    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                    <div class="box-tools">
                        <a href="{{ route('operation_index', $id->id) }}" class="btn btn-sm btn-primary">Volver</a>
                    </div>
            </div>
            <form action="{{ route('operation_store', $id->id) }}" method="POST">
                @method('POST')
                @csrf
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="empresa" id="empresa" class="form-control">
                                    ...
                                    <option value="LITEYCA">LITEYCA</option>
                                    <option value="LITEYCA">LITEYCA</option>
                                    <option value="LITEYCA">LITEYCA</option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="fechaElaboracion" value="{{ old('fechaElaboracion') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <td class="text-center"><input type="radio" id="fotos[antes][NO]" name="fotos[antes]" value="SI" checked></td>
                            <label for="fotos[antes][NO]">NO</label>
                            <td class="text-center"><input type="radio" id="fotos[antes][SI]"  name="fotos[antes]" value="NO"></td>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <td class="text-center"><input type="radio" id="fotos[despues][NO]" name="fotos[despues]" value="SI" checked></td>
                            <label for="fotos[despues][NO]">NO</label>
                            <td class="text-center"><input type="radio" id="fotos[despues][SI]"  name="fotos[despues]" value="NO"></td>
                        </div>
                    </div>
                </div>
                    <div class="content">
                        <div class="panel box box-success">
                            ...
                            <div id="collapseZero" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.operacion.includes.dates_generals')
                                </div>
                            </div>
                        </div>
                        <div class="panel box box-info">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.operacion.includes.activity')
                                </div>
                            </div>
                        </div>
                        <div class="panel box box-warning">
                            ...
                            <div id="collapseFive" class="panel-collapse collapse">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        @include('execution_works.maintenance.operacion.includes.hallazgos')
                                    </div>
                                </div>
                            </div>
                        </div>
