    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                    <div class="box-tools">
                        <a href="{{ route('land_index', $id->id) }}" class="btn btn-sm btn-primary">Volver</a>
                    </div>
            </div>
            <form action="{{ route('land_store', $id->id) }}" method="POST">
                @method('POST')
                @csrf
                <div class="box-body">
                    ...
                    <div class="content">
                        <div class="panel box box-success">
                            ...
                            <div id="collapseZero" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.tierra.includes.dates_generals')
                                </div>
                            </div>
                        </div>
                        <div class="panel box box-info">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.tierra.includes.pruebas')
                                </div>
                            </div>
                        </div>
                        <div class="panel box box-danger">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse">
                                <div class="box-body">
                                    @include('execution_works.maintenance.tierra.includes.check_list')
                                </div>
                            </div>
                        </div>
