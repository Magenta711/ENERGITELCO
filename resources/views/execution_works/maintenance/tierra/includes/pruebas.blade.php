...
<div class="body">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                <input type="text" class="form-control"  name="medicion[{{ $i }}][medicion_1]" id="medicion[{{ $i }}][medicion_1]">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <input type="text" class="form-control"  name="medicion[{{ $i }}][medicion_2]" id="medicion[{{ $i }}][medicion_2]">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <input type="text" class="form-control"  name="medicion[{{ $i }}][medicion_3]" id="medicion[{{ $i }}][medicion_3]">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <input type="text" class="form-control"  name="medicion[{{ $i }}][resistencia]" id="medicion[{{ $i }}][resistencia]">
            </div>
        </div>
        <hr>
        <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" name="medicion_resistencia[1][resistencia]" class="form-control" id="medicion_resistencia[1][resistencia]" value="{{ old('medicion_resistencia[1][resistencia]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[1][power]">ρ (Ω*m)</label>
                <input type="text" name="medicion_resistencia[1][power]" class="form-control" id="medicion_resistencia[1][power]" value="{{ old('medicion_resistencia[1][power]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[2][resistencia]">RESISTENCIA (Ω)</label>
                <input type="text" name="medicion_resistencia[2][resistencia]" class="form-control" id="medicion_resistencia[2][resistencia]" value="{{ old('medicion_resistencia[2][resistencia]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[2][power]">ρ (Ω*m)</label>
                <input type="text" name="medicion_resistencia[2][power]" class="form-control" id="medicion_resistencia[2][power]" value="{{ old('medicion_resistencia[2][power]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[3][resistencia]">RESISTENCIA (Ω)</label>
                <input type="text" name="medicion_resistencia[3][resistencia]" class="form-control" id="medicion_resistencia[3][resistencia]" value="{{ old('medicion_resistencia[3][resistencia]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[3][power]">ρ (Ω*m)</label>
                <input type="text" name="medicion_resistencia[3][power]" class="form-control" id="medicion_resistencia[3][power]" value="{{ old('medicion_resistencia[3][power]') }}">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" name="medicion_resistencia[4][resistencia]" class="form-control" id="medicion_resistencia[4][resistencia]" value="{{ old('medicion_resistencia[4][resistencia]') }}">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="text-center" for="medicion_resistencia[4][power]">ρ (Ω*m)</label>
                <input type="text" name="medicion_resistencia[4][power]" class="form-control" id="medicion_resistencia[4][power]" value="{{ old('medicion_resistencia[4][power]') }}">
            </div>
        </div>
    </div>
    <hr>
