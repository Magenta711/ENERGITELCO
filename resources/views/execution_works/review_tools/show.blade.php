        ...
        <div class="col-md-12">
            <div class="box">
                ...
                @if ($id->created_at<'2024-09-15 00:00:00')
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-4"><strong>{{++$i}}</strong><br>Utilizó multímetro patrón para evaluar el estado del multímetro</div>
                        <div class="col-md-4"><strong>Cantidad</strong><br>{{$id->cantidad_3}}</div>
                        <div class="col-md-4"><strong>Marca</strong><br>{{$id->marca_3}}</div>
                        <div class="col-md-12"><strong>Observaciones</strong><br>{!! str_replace("\n", '</br>', addslashes($id->observacion_3))!!}</div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4"><strong>{{++$i}}</strong><br>Impermeable para moto</div>
                        <div class="col-md-4"><strong>Cantidad</strong><br>{{$id->cantidad_48}}</div>
                        <div class="col-md-4"><strong>Marca</strong><br>{{$id->marca_48}}</div>
                        <div class="col-md-12"><strong>Observaciones</strong><br>{!! str_replace("\n", '</br>', addslashes($id->observacion_48))!!}</div>
                    </div>
                    @endif
                    @if ($id->commentary)
                        <hr>
