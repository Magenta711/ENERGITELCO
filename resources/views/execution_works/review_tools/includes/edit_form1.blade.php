...
@if ($id->created_at<'2024-09-15 00:00:00')
<div class="form-group row">
...
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Utilizó multímetro patrón para evaluar el estado del multímetro</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger"></span></label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_3}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger"></span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_3}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones <span class="text-danger"></span></label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_3')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Cables USB 2.0 o ETHERNET</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Ponchadora BNC</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_6}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_6}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones</label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_6')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Ponchadora RJ45</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Alicate</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_16}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_16}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones <span class="text-danger">*</span></label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_16')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Mango de sierra</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_17}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_17}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones</label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_17')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Juego de llaves combinadas</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_18}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_18}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones <span class="text-danger">*</span></label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_18')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Llave de expansión pequeña</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_19}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_19}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones</label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_19')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Llave de expansión grande 12 pulgadas</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Led de prueba super importante</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_22}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_22}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones <span class="text-danger">*</span></label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_22')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Extensión eléctrica</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Broca de muro</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_29}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_29}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-3 col-sm-4">
        <label for="marca_{{$i}}">Marca</label>
        <select name="marca_30" id="marca_30" class="form-control">
            <option selected disabled></option>
            @foreach ($computers as $item)
                <option {{old('marca_30')}} value="{{$item->id}}">{{$item->id}} - {{$item->serial}}</option>
            @endforeach
        </select>
    </div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Escritorio</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_38}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_38}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones</label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_38')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Arnés</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Freno para guaya de 10 mm</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">**</span></label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_46}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">**</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_46}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones <span class="text-danger">**</span></label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_46')}}</textarea></div>
</div>
<hr>
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Equipo de protección caídas para moto</div>
...
<div class="form-group row">
    <div class="col-md-2 col-sm-4 mb-3"><Strong>Ítem {{++$i}}</Strong><br> Impermeable para moto</div>
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{ $id->cantidad_48}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{ $id->marca_48}}" class="form-control"></div>
    <div class="col-md-5 col-sm-12 mb-1"><label for="observacion_{{$i}}">Observaciones</label><textarea name="observacion_{{$i}}" id="observacion_{{$i}}" cols="30" rows="2" class="form-control">{{old('observacion_48')}}</textarea></div>
</div>
@endif
