...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger"></span></label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_3')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger"></span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_3')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_6')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_6')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_16')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_16')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_17')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_17')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_18')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_18')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_19')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_19')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">*</span></label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_22')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">*</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_22')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_29')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_38')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_38')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad <span class="text-danger">**</span></label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_46')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca <span class="text-danger">**</span></label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_46')}}" class="form-control"></div>
...
<div class="form-group row">
    ...
    <div class="col-md-2 col-sm-4"><label for="cantidad_{{$i}}">Cantidad</label><input type="number" name="cantidad_{{$i}}" value="{{old('cantidad_48')}}" id="cantidad_{{$i}}" class="form-control"></div>
    <div class="col-md-3 col-sm-4"><label for="marca_{{$i}}">Marca</label><input type="text" name="marca_{{$i}}" id="marca_{{$i}}" value="{{old('marca_48')}}" class="form-control"></div>
