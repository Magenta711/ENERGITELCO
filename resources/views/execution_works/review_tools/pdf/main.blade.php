...
<body>
    ...
    <main>
        ...
        <tbody>
            ...
            @if ($trabajo->created_at<'2024-09-15 00:00:00')
            <tr>
                <td>{{++$i}}</td>
                <td>Brújula (GPS)</td>
            ...
            <tr>
                <td>{{++$i}}</td>
                <td>Utilizó multímetro patrón para evaluar el estado del multímetro</td>
                <td>{{$trabajo->cantidad_3}}</td>
                <td>{{$trabajo->marca_3}}</td>
                <td>{{$trabajo->observacion_3}}</td>
            </tr>
            ...
            <tr>
                <td>{{++$i}}</td>
                <td>Impermeable para moto</td>
                <td>{{$trabajo->cantidad_48}}</td>
                <td>{{$trabajo->marca_48}}</td>
                <td>{{$trabajo->observacion_48}}</td>
            </tr>
            @endif
            <tr>
