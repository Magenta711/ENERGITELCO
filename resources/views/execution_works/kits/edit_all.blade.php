                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" readonly name="name1" value="{{ $id->responsable->name }}"
                                        class="form-control controlName" id="nombre1" placeholder="Nombre">
                                </div>
                                <div class="col-sm-4">
                                    <label for="rol1">Rol autorizado</label>
                                    <input type="text" readonly name="rol1"
                                        value="{{ $id->responsable->position->name }}" class="form-control controlRol"
                                        id="rol1" placeholder="Rol">
                                </div>
                            </div>
                            <hr>
                            <div id="list_tools">
                                ...
                                @else
                                    ...
                                    @foreach ($id->tools as $tool)
                                        <input type="hidden" name="item_id[{{ $i }}]"
                                            id="item_id_{{ $i }}" value="{{ $tool->perent_id ?? $tool->id }}"
                                            class="tools_id">
                                        <div class="form-group row">
                                            <div class="col-md-2 col-sm-4 mb-3">
                                                <Strong>Implemento {{ $i + 1 }}</Strong><br>
                                    ...
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-success btn-send"
