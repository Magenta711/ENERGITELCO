                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Se encuentra en proceso de finalización de contrato en {{ config('app.name') }} SAS. Para finalizar el proceso ser requiere de firmar virtual de los documentos adjuntos en la plataforma web.</p>
                                        <p
                                        style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Después de que se realice el proceso por usuario y contraseña estos serán revocados, para la facilidad de acceso de clic en el botón.
                                        </p>
                                        ...
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            JORGE ANDRES ORTEGA BEDOYA.<br>DIRECTOR DE PROYECTOS ENERGITELCO
                                            S.A.S.<br>INGENIERO ELECTRÓNICO USB MEDELLIN<br>311 306 6482, 314 618 4125,
                                            (4) 2307276<br>CALLE 48B NRO 66-65 MEDELLIN ANT.
                                        </p>
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            JORGE.ORTEGA@energitelco.com.co</p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Si tienes problemas haciendo click en el botón "Dar aquí para
                                                        ingresar", copia y pega el siguiente
                                                        enlace en tu navegador: <a
                                                            href="{{ config('app.url') }}/user/end_work/signature"
                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3869d4;">{{ config('app.url') }}/user/end_work/signature</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
