                            <p><label for="period">1. Calidad de los productos o servicios.</label></p>
                            ...
                            <hr>
                            <p><label for="period">2. Puntualidad en la entrega.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">3. Disponibilidad en la atención.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">4. Precio.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">5. Aplicación de descuentos.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">6. Variedad de productos o servicios</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">7. Agilidad en la cotización.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">8. Garantía.</label></p>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_8" {{(old('item_8') == null) ? 'checked' : ''}} id="item_8_NA" value="">
                                <label class="form-check-label" for="item_8_NA">NA. No aplica</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_8" {{(old('item_8') == 1) ? 'checked' : ''}} id="item_8_1" value="1">
                                <label class="form-check-label" for="item_8_1">1. Deficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_8" {{(old('item_8') == 2) ? 'checked' : ''}} id="item_8_2" value="2">
                                <label class="form-check-label" for="item_8_2">2. Insuficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_8" {{(old('item_8') == 3) ? 'checked' : ''}} id="item_8_3" value="3">
                                <label class="form-check-label" for="item_8_3">3. regular</label>
                            </div>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">9. Transporte en la entrega de los insumos.</label></p>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == null) ? 'checked' : ''}} id="item_8_NA" value="">
                                <label class="form-check-label" for="item_9_NA">NA. No aplica</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == 1) ? 'checked' : ''}} id="item_9_1" value="1">
                                <label class="form-check-label" for="item_9_1">1. Deficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == 2) ? 'checked' : ''}} id="item_9_2" value="2">
                                <label class="form-check-label" for="item_9_2">2. Insuficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == 3) ? 'checked' : ''}} id="item_9_3" value="3">
                                <label class="form-check-label" for="item_9_3">3. regular</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == 4) ? 'checked' : ''}} id="item_9_4" value="4">
                                <label class="form-check-label" for="item_9_4">4. Bueno</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_9" {{(old('item_9') == 5) ? 'checked' : ''}} id="item_9_5" value="5">
                                <label class="form-check-label" for="item_9_5">5. Excelente</label>
                            </div>
                            <hr>
                            <p><label for="period">10. Atención de quejas y reclamos.</label></p>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == null) ? 'checked' : ''}} id="item_10_NA" value="">
                                <label class="form-check-label" for="item_10_NA">NA. No aplica</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == 1) ? 'checked' : ''}} id="item_10_1" value="1">
                                <label class="form-check-label" for="item_10_1">1. Deficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == 2) ? 'checked' : ''}} id="item_10_2" value="2">
                                <label class="form-check-label" for="item_10_2">2. Insuficiente</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == 3) ? 'checked' : ''}} id="item_10_3" value="3">
                                <label class="form-check-label" for="item_10_3">3. regular</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == 4) ? 'checked' : ''}} id="item_10_4" value="4">
                                <label class="form-check-label" for="item_10_4">4. Bueno</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="item_10" {{(old('item_10') == 5) ? 'checked' : ''}} id="item_10_5" value="5">
                                <label class="form-check-label" for="item_10_5">5. Excelente</label>
                            </div>
                            <hr>