                            <p><label for="period">1. Se encuentran avalados para prestar los servicios ofertados.</label></p>
                            ...
                            <hr>
                            <p><label for="period">2. La capacitación ofrecida es eficaz.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">3. Las instalaciones de la formación son adecuadas.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">4. Los instructores se encuentran certificados.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">5. El equipo utilizado en la instrucción es idóneo.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">6. Costos eficientes.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">7. El tiempo de entrega de los certificados es oportuna.</label></p>
                            <div class="form-check form-check-inline">
