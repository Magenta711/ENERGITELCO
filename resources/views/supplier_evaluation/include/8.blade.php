<p><label>1. Conocimientos en la labor a desempeñar.</label></p>
...
<hr>
<p><label>2. Puntuación en la entrega de informes.</label></p>
<div class="form-check form-check-inline">
...
<hr>
<p><label>3. Disponibilidad en resolver inquietudes.</label></p>
<div class="form-check form-check-inline">
...
<hr>
<p><label>4. Costo de servicio.</label></p>
<div class="form-check form-check-inline">
...
<hr>
<p><label>5. Nivel académico (títulos, Cursos, etc.).</label></p>
<div class="form-check form-check-inline">
...
<hr>
<p><label>6. Cumplimiento en las labores desempeñadas.</label></p>
<div class="form-check form-check-inline">
