                            <p><label for="period">1. La plataforma web es eficiente.</label></p>
                            ...
                            <hr>
                            <p><label for="period">2. Asistencia telefónica para reporte de accidentes e incidentes.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">3. Reconocimiento oportuno prestaciones económicas.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">4. Es eficiente la red asistencial de la ARL.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">5. Asesoría brindada por la ARL.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">6. Capacitaciones ofrecidas por la ARL.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label for="period">7. Asesoría de implementación en el SGSST.</label></p>
                            <div class="form-check form-check-inline">
