                            <p><label>1. Calidad de los productos o servicios.</label></p>
                            ...
                            <hr>
                            <p><label>2. Puntualidad en la entrega</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>3. Disponibilidad en la atención.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>5. Aplicación de descuentos.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>6. Variedad de productos o servicios</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>7. Agilidad en la cotización.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>9. Transporte en la entrega de los insumos.</label></p>
                            <div class="form-check form-check-inline">
                            ...
                            <hr>
                            <p><label>10. Atención de quejas y reclamos.</label></p>
                            <div class="form-check form-check-inline">
