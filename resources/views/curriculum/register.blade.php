                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 @error('name') has-error @enderror">
                            <input id="name" type="text" class="form-control" name="name" value="{{ $id->name }}" autocomplete="off" autofocus placeholder="Nombres y apellidos">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 @error('email') has-error @enderror">
                            <input id="email" type="email" class="form-control" name="email" value="{{ $id->email }}" autocomplete="off" placeholder="{{ __('E-Mail Address') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 @error('cedula') has-error @enderror">
                            <input id="cedula" type="text" class="form-control" name="cedula" value="{{ $id->document }}" autocomplete="off" placeholder="Número de documento">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 @error('direccion') has-error @enderror">
                            <input id="direccion" type="text" class="form-control" name="direccion" value="{{ $id->address }}" autocomplete="off" placeholder="Dirección">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 @error('telefono') has-error @enderror">
                            <input id="telefono" type="text" class="form-control" name="telefono" value="{{ $id->tel }}" autocomplete="off" placeholder="Teléfono">
                        ...
                        <div class="col-md-6 @error('position_id') has-error @enderror">
                            <select name="position_id" id="position_id" class="form-control">
                                ...
                                @foreach ($positions as $position)
                                    <option {{ ($id->position->id == $position->id) ? 'selected' : ''}} value="{{$position->id}}">{{$position->name}}</option>
                                @endforeach
                            </select>
