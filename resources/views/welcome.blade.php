...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary js-scroll-trigger" href="#about">Nosotros</a>
                </div>
            </div>
        </header>
        <!-- About-->
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container">
                ...
                <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                    <div class="col-lg-6"><img class="img-fluid" src="https://energitelco.com/assets/img/microondas12.jpg" alt="" /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Instalación de soluciones de Última Milla en Fibra Óptica, Microondas y Satelital</h4>
                                    <p class="mb-0 text-white-50">Realizamos instalación de soluciones terrestres  para trasporte de datos en tecnologías de última generación en FO, MW y Satelital.</p>
                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-6"><img class="img-fluid" src="https://energitelco.com/assets/img/power1.jpg" alt="" /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Instalación Power y UPS</h4>
                                    <p class="mb-0 text-white-50">Se instalan equipos de rectificación de corriente directa y corriente alterna para respaldar sistemas de telecomunicaciones.</p>
                ...
                <!-- Project Tree Row-->
                <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                    <div class="col-lg-6"><img class="img-fluid" src="https://energitelco.com/assets/img/bts11.jpg" alt="" /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Instalación y desmonte BTS 2G, 3G, 4G y 5G</h4>
                                    <p class="mb-0 text-white-50">Se realiza instalación de equipos de comunicación celular en todas las tecnologías y bandas licenciadas en Colombia.</p>
                                    <hr class="d-none d-lg-block mb-0 ml-0" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    ...
                                    <p class="mb-0 text-white-50">Realizamos instalación de sistemas de energía alternativa de tipo solar y eólica con sus sistemas de regulación e inversión para respaldar sistemas de telecomunicaciones.</p>
                                    <hr class="d-none d-lg-block mb-0 mr-0" />
                                </div>
                            </div>
                        </div>
                ...
                <!-- Project Five Row-->
                <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                    <div class="col-lg-6"><img class="img-fluid" src="https://energitelco.com/assets/img/motogenerador2.jpg" alt="" /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Instalación de motogeneradores</h4>
                                    <p class="mb-0 text-white-50">Se instalan equipos electrógenos de respaldo y de trabajo continuo de 10Kw  a 100 Kw en toda la geografía nacional.</p>
                                    <hr class="d-none d-lg-block mb-0 ml-0" />
                                </div>
                            </div>
                        </div>
                ...
                <!-- Project Six Row-->
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-6"><img class="img-fluid" src="https://energitelco.com/assets/img/route.png" alt="" /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Instalación y mantenimiento de Centros Digitales</h4>
                                    <p class="mb-0 text-white-50">Somos instaladores de centros digitales integrales desde última milla hasta puesta en marcha de sistemas de Wifi para cubrir grandes áreas del sector público y privado.</p>
                                    <hr class="d-none d-lg-block mb-0 mr-0" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50">CLL 48B #66-65 MEDELLÍN ANT</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50"><a href="#!">jorge.ortega@energitelco.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4" />
                                <div class="small text-black-50">507 2074</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="social d-flex justify-content-center">
                    <a class="mx-2" href="https://www.instagram.com/energitelco.014"><i class="fab fa-instagram"></i></a>
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container">Copyright © ENERGITELCO 2021</div></footer>
        <!-- Bootstrap core JS-->
