    ...
    {{-- Content main --}}
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <a href="{{route('users')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <a href="{{route('project')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <a href="{{route('approval')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="{{route('work_permit')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            {{-- <!-- ./col --> --}}
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <a href="{{route('customers')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <a href="{{route('providers')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                ...
                <a href="{{route('job_application')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                ...
                <a href="{{route('interview')}}" class="small-box-footer btn-send">Más información <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            {{-- <div class="col-xs-12">
    ...
    <div class="row">
            ...
            <div class="col-sm-2 col-xs-3">
                <div class="box">
                    <a href="{{ route('cvs_invoices') }}" class="btn-send">
                        <div class="description-block border-right">
                            <span class="description-percentage text-green"><i class="fa fa-file-invoice-dollar"></i></span>
                            <h5 class="description-header">CVS</h5>
            ...
            <div class="box box-danger">
                <a href="#" class="btn-send">
                    <div class="description-block border-right">
                        ...
                        <h5 class="description-header">Solicitud</h5>
                        <span class="description-text">Retiro de cesantisas</span>
                    </div>
                </a>
            </div>
            <!-- /.description-block -->
        ...
        <div class="col-sm-2 col-xs-3 hide">
            <div class="box box-info">
                <a href="#" class="btn-send">
                    <div class="description-block border-right">
                        <span class="description-percentage text-green"><i class="fa fa-envelope-open-text"></i></span>
                        <h5 class="description-header">Solicitud</h5>
                        <span class="description-text">Carta laboral</span>
                    </div>
                </a>
            </div>
            <!-- /.description-block -->
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            @foreach ($bill_types as $bill_type)
                                <li class="{{ ($bill_type->id == 1) ? 'active' : '' }}"><a href="#tab_{{ $bill_type->id }}" data-toggle="tab">{{ $bill_type->name }}</a></li>
                            @endforeach
                            <li class="pull-left header"></li>
                        </ul>
                        <div class="tab-content">
                            @foreach ($bill_types as $bill_type)
                                <div class="tab-pane {{ ($bill_type->id == 1) ? 'active' : '' }}" id="tab_{{ $bill_type->id }}">
                                        <div class="row">
                                            @foreach ($bill_type->documents as $cartel)
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <span class="mailbox-attachment-icon {{$type == "jpg" || $type == "png" || $type == "jpeg" ? 'has-img' : ''}}" id="icon_{{$cartel->id}}">
                                                    ...
                                                    <div class="mailbox-attachment-info">
                                                        <p class="mailbox-attachment-name" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;" data-toggle="tooltip" title="{{$cartel->name_document}}"><i class="fa fa-paperclip"></i><span id="name_{{$cartel->id}}">{{$cartel->name_document}}</span></p>
                                                        <span class="mailbox-attachment-size">
                                                            .
                                                            <span id="size_{{$cartel->cartel}}">{{$cartel->size}}</span>
                                                            <a target="_black" href="/file/billboard/{{$cartel->document}}" class="btn btn-default btn-xs pull-right"><i class="fa fa-download"></i></a>
                                                        </span>
                                                    </div>
                                                </div>
                                            @endforeach
...
@section('js')
    ...
    <script>
        ...
        Swal.fire({
            ...
            Swal.fire({
                html: '<h1 style="font-size: 16pt;color:#0080ff;">RECONOCIMIENTO AL EMPLEADO DEL MES</h1><p style="font-size: 14pt;color:#252525">"No es lo que sabes, es lo que haces con lo que sabes"</p><div style="display: flex;"><div style="width:40%"><div style="display: flex;width:100%"><div style="border: 1px solid #000000;width: 33.3%"><p>ENERO</p><img src="img/hernan_villa.jpg" width="100%"><p font-size: 12pt;color:#0080ff;>HERNAN VILLA</p></div><div style="border: 1px solid #000000;width: 33.3%"><p>FEBRERO</p><img src="img/161012067620210108_104153.jpg" width="100%"><p font-size: 12pt;color:#0080ff;>JORDAN GIRALDO</p></div><div style="border: 1px solid #000000;width: 33.3%"><p>MARZO</p><img src="img/1610309511IMG-20210110-WA0001.jpg" width="100%"><p font-size: 12pt;color:#0080ff;>JAIRO GARCIA</p></div></div><div style="display: flex;width:100%"><div style="border: 1px solid #000000;width: 33.3%"><p>ABRIL</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>MAYO</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>JUNIO</p><img src="img/anonimus.png" width="100%"></div></div><div style="display: flex;width:100%"><div style="border: 1px solid #000000;width: 33.3%"><p>JULIO</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>AGOSTO</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>SEPTIEMBRE</p><img src="img/anonimus.png" width="100%"></div></div><div style="display: flex;"><div style="border: 1px solid #000000;width: 33.3%"><p>OCTUBRE</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>NOBIEMBRE</p><img src="img/anonimus.png" width="100%"></div><div style="border: 1px solid #000000;width: 33.3%"><p>DICIEMBRE</p><img src="img/anonimus.png" width="100%"></div></div></div><div  style="width:60%"><p style="font-size: 12pt">Comenzaremos de nuevo este año, con el programa y la motivación para que seas el empleado del mes.</p><p style="font-size: 12pt">Te invitamos a que leas y te enteres de nuestros valores corporativos que encuentran y lo apliques en tu vida laboral diaria.</p><p style="font-size: 12pt">Los valores son.</p><ul style="font-size: 12pt;text-align:left"><li>Honestidad</li><li>Saber seguir instrucciones</li><li>Estar de lado de la empresa (Lealtad)</li><li>Compromiso</li><li>Desarrollo humano</li><li>Respeto</li></ul><p style="font-size: 14pt;color:#252525">¡Anímate a ser el mejor compañero y colaborador del mes!</p></div></div><p><small style="font-size: 9pt">ENERGITELCO S.A.S.</small></p>',
                width: 1000,
...
{{-- Add two label to cvs_payment_cuts --}}

{{-- Reorganizar y modelar permisos para formatos de gestion --}}

{{-- comentario a la venta de 138 "Se cambio el valor de la venta por 582900 debido al descuento del equipo sin iva" --}}

{{-- Estado nuevo en caso de devolucion del dinero, devolver produtos al inventario --}}
