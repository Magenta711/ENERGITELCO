...
<section class="content">
    <div class="box">
        ...
        <form action="{{route('cvs_admin_sims_type_store')}}" method="post" autocomplete="off">
            @csrf
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
            ...
            @foreach ($sedes as $item)
                <div class="form-gruop">
                    ...
                    <input type="text" name="prices[{{ $item->id }}]" id="prices_{{ $item->id }}" class="form-control" value="0">
                </div>
                <hr>
            @endforeach
        </div>
