                    ...
                    <ul class="treeview-menu">
                        ...
                        @if (auth()->user()->hasAnyPermission(['Lista de cortes de multas', 'Editar cortes de multas', 'Ver cortes de multas']))
                            <li class="{{ activeMenu('logistics_infrastructure/transit_taxes*') }}"><a
                                    class="btn-send" href="{{ route('transit_taxes') }}"><i class="fa fa-print"></i>
                                    MULTAS DE TRÁNSITO</a></li>
                        @endif
                            ...
                            <li
                                ...
                                <ul class="treeview-menu">
                                    @if (auth()->user()->hasAnyPermission([
                                        ...
                                        <li class="{{ activeMenu('finances/bonus/minor_box*') }}"><a class="btn-send"
                                                href="{{ route('bonus_minor_box') }}"><i class="fa fa-box"></i> CAJA
                                                MENOR</a></li>
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if (auth()->user()->hasAnyPermission([
                            ...
                            <li class="{{ activeMenu('performance_evaluation*') }}"><a class="btn-send"
                                    href="{{ route('performance_evaluation') }}"><i class="fa fa-theater-masks"></i>
                                    EVALUACIÓN DE DESEMPEÑO</a></li>
                        @endif
                        @if (auth()->user()->hasAnyPermission([
                                    'Aprobar llamados de atención',
                                    'Editar llamados de atención',
                            ...
                            <li class="{{ activeMenu('attention_call*') }} {{ activeMenu('show_called*') }}"> <a
                                    class="btn-send"href="{{ route('attention_call') }}"><i class="fa fa-gavel"></i>
                                    DESCARGOS</a></li>
                        @endif
                        @if (auth()->user()->hasAnyPermission([
                                    'Crear memorandos',
