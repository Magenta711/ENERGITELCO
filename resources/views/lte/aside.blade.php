    ...
    <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
       <li class="header">Menú principal</li>
        ...
        {{-- DIRECCION --}}
        @if ( auth()->user()->hasAnyPermission(['Aprobar entrevistas','Aprobar evaluación de desempeño','Aprobar hojas de vida','Aprobar llamados de atención','Aprobar proyectos','Aprobar solicitud de entrega de dotación personal','Aprobar solicitud de Inspección detallada de vehículos','Aprobar solicitud de Inspección y protección contra caídas','Aprobar solicitud de lista de verificación para el mantenimiento de computadores','Aprobar solicitud de permiso laboral o notificación de incapacidad','Aprobar solicitud de Permisos de trabajo','Aprobar solicitudes permisos propios','Aprobar solicitud de Revisión y asignación de herramientas','Crear proveedores','Editar proveedores','Eliminar proveedores','Lista de proveedores','Ver proveedores','Calificar evaluaciones de proveedores','Disparar evaluación a proveedores','Eliminar evaluación de proveedores','Lista de evaluaciones de proveedores','Ver evaluaciones de proveedores'] ) )
            <li class="treeview {{ activeMenu('tasking*') }}{{ activeMenu('forms*') }}{{ activeMenu('approval*') }}{{ activeMenu('provider*') }}{{ activeMenu('indicators*') }}{{ activeMenu('supplier_evaluation*') }}">
              ...
              <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['Aprobar entrevistas','Aprobar evaluación de desempeño','Aprobar hojas de vida','Aprobar llamados de atención','Aprobar proyectos','Aprobar solicitud de entrega de dotación personal','Aprobar solicitud de Inspección y protección contra caídas','Aprobar solicitud de Inspección detallada de vehículos','Aprobar solicitud de lista de verificación para el mantenimiento de computadores','Aprobar solicitud de permiso laboral o notificación de incapacidad','Aprobar solicitud de Permisos de trabajo','Aprobar solicitudes permisos propios','Aprobar solicitud de Revisión y asignación de herramientas','Aprobar reporte de novedades de nómina y horas extras' ]) )
                ...
                @endif
                @if ( auth()->user()->hasAnyPermission([ 'Lista de indicadores','Crear indicadores','Informe de indicadores','Seguimiento de indicadores','Administración de indicadores']) )
                ...
                @if (auth()->user()->hasAnyPermission([ 'Lista de programaciones en frente de trabajo','Ver programaciones en frente de trabajo','Crear programacion en frente de trabajo','Editar programaciones en frente de trabajo' ]) )
                  <li class="{{ activeMenu('tasking*') }}"><a href="{{route('tasking')}}"><i class="fa fa-tasks"></i> FRENTE DE TRABAJO</a></li>
                @endif
                @if ( auth()->user()->hasAnyPermission(['Lista de formularios','Ver formularios','Crear formularios','Editar formularios','Eliminar formularios','Ver respuestas de formularios']) )
                    <li class="{{ activeMenu('forms*') }}"><a href="{{route('forms')}}"><i class="fab fa-wpforms"></i> FORMULARIOS</a></li>
                @endif
                @if ( auth()->user()->hasAnyPermission(['Crear proveedores','Editar proveedores','Eliminar proveedores','Lista de proveedores','Ver proveedores','Calificar evaluaciones de proveedores','Disparar evaluación a proveedores','Eliminar evaluación de proveedores','Lista de evaluaciones de proveedores','Ver evaluaciones de proveedores']) )
                    <li class="treeview {{ activeMenu('provider*') }}{{ activeMenu('supplier_evaluation*') }}">
                      ...
                      <ul class="treeview-menu">
                        @if (auth()->user()->hasAnyPermission(['Crear proveedores','Disparar evaluación a proveedores','Editar proveedores','Eliminar proveedores','Lista de proveedores','Ver proveedores']))
                            <li class="{{ activeMenu('provider*') }}"><a class="btn-send" href="{{ route('providers') }}"><i class="fa fa-truck"></i> PROVEEDORES</a></li>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Calificar evaluaciones de proveedores','Disparar evaluación a proveedores','Eliminar evaluación de proveedores','Lista de evaluaciones de proveedores','Ver evaluaciones de proveedores']))
        ...
        @if (auth()->user()->hasAnyPermission(['Aprobar proyectos','Crear proyectos','Editar proyectos','Lista de proyectos','Ver proyectos','Lista de actividades de proyectos','Ver actividades de proyecto','Crear actividades de proyecto','Editar actividades de proyecto','Lista de consumibles para proyectos','Ver consumibles para proyectos','Crear consumibles para proyectos','Editar consumibles para proyectos','Lista de materiales para proyectos','Ver materiales para proyectos','Crear materiales para proyectos','Editar materiales para proyectos','Lista de comisiones para técnicos de proyectos','Crear comisiones para técnicos de proyectos','Editar comisiones para técnicos de proyectos','Lista de comisiones para coordinadores de proyectos','Crear comisiones de control de proyectos','Editar comisiones de control de proyectos','Lista de inventarios de consumibles en bodega','Crear consumible del inventario','Editar consumible del inventario','Ver consumible del inventario','Eliminar consumible del inventario','Lista de inventarios de equipos Mintic','Crear equipo al inventario Mintic','Editar equipo al inventario Mintic','Ver equipo al inventario Mintic','Eliminar equipo al inventario Mintic','Ver implementación proyectos de MINTIC','Crear asiganción de implemetación de MINTIC','Editar asiganción de implemetación de MINTIC','Ejecutar asiganción de implemetación de MINTIC','Ver asiganción de implemetación de MINTIC','Lista de proyectos de MINTIC','Eliminar asiganción de implemetación de MINTIC']))
          <li class="treeview {{ activeMenu('execution_works*') }}{{ activeMenu('project*') }}">
            ...
            <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['Aprobar proyectos','Crear proyectos','Editar proyectos','Lista de proyectos','Ver proyectos','Lista de actividades de proyectos','Ver actividades de proyecto','Crear actividades de proyecto','Editar actividades de proyecto','Lista de consumibles para proyectos','Ver consumibles para proyectos','Crear consumibles para proyectos','Editar consumibles para proyectos','Lista de materiales para proyectos','Ver materiales para proyectos','Crear materiales para proyectos','Editar materiales para proyectos','Lista de comisiones para técnicos de proyectos','Crear comisiones para técnicos de proyectos','Editar comisiones para técnicos de proyectos','Lista de comisiones para coordinadores de proyectos','Crear comisiones de control de proyectos','Lista de proyectos de rutas','Crear proyectos de rutas','Eliminar proyectos de rutas','Ver proyectos de rutas','Editar proyectos de rutas','Aprobar proyectos de rutas','Editar comisiones de control de proyectos','Lista de inventarios de consumibles en bodega','Crear consumible del inventario','Editar consumible del inventario','Ver consumible del inventario','Eliminar consumible del inventario','Lista de inventarios de equipos Mintic','Crear equipo al inventario Mintic','Editar equipo al inventario Mintic','Ver equipo al inventario Mintic','Eliminar equipo al inventario Mintic','Ver implementación proyectos de MINTIC','Crear asiganción de implemetación de MINTIC','Editar asiganción de implemetación de MINTIC','Ejecutar asiganción de implemetación de MINTIC','Ver asiganción de implemetación de MINTIC','Lista de inventarios de equipos Mintic','Crear equipo al inventario Mintic','Ver equipo al inventario Mintic','Editar equipo al inventario Mintic','Eliminar equipo al inventario Mintic','Lista de proyectos de MINTIC','Eliminar asiganción de implemetación de MINTIC']))
              <li class="treeview {{ activeMenu('project*') }}">
                <a href="#"><i class="fa fa-cubes"></i> PROYECTOS<span class="pull-right-container">
                    ...
                    <ul class="treeview-menu">
                      @if (auth()->user()->hasAnyPermission(['Aprobar proyectos','Crear proyectos','Editar proyectos','Lista de proyectos','Ver proyectos','Lista de actividades de proyectos','Ver actividades de proyecto','Crear actividades de proyecto','Editar actividades de proyecto','Lista de consumibles para proyectos','Ver consumibles para proyectos','Crear consumibles para proyectos','Editar consumibles para proyectos','Lista de materiales para proyectos','Ver materiales para proyectos','Crear materiales para proyectos','Editar materiales para proyectos','Lista de comisiones para técnicos de proyectos','Crear comisiones para técnicos de proyectos','Editar comisiones para técnicos de proyectos','Lista de comisiones para coordinadores de proyectos','Crear comisiones de control de proyectos','Lista de proyectos de rutas','Crear proyectos de rutas','Eliminar proyectos de rutas','Ver proyectos de rutas','Editar proyectos de rutas','Aprobar proyectos de rutas','Editar comisiones de control de proyectos']))
                        <li class="treeview {{ activeMenu('project/setting*') }}{{ activeMenu('projects*') }}">
                          ...
                          <ul class="treeview-menu">
                            @if (auth()->user()->hasAnyPermission(['Aprobar proyectos','Crear proyectos','Editar proyectos','Lista de proyectos','Ver proyectos']))
                                <li class="{{ activeMenu('projects*') }}"><a class="btn-send" href="{{route('project')}}"><i class="fa fa-cubes"></i> PROYECTOS</a></li>
                            @endif
                            @if (auth()->user()->hasAnyPermission(['Lista de actividades de proyectos','Ver actividades de proyecto','Crear actividades de proyecto','Editar actividades de proyecto','Lista de consumibles para proyectos','Ver consumibles para proyectos','Crear consumibles para proyectos','Editar consumibles para proyectos','Lista de materiales para proyectos','Ver materiales para proyectos','Crear materiales para proyectos','Editar materiales para proyectos','Lista de comisiones para técnicos de proyectos','Crear comisiones para técnicos de proyectos','Editar comisiones para técnicos de proyectos','Lista de comisiones para coordinadores de proyectos','Crear comisiones de control de proyectos','Editar comisiones de control de proyectos']))
                              <li class="treeview {{ activeMenu('project/setting*') }}">
                                ...
                                <ul class="treeview-menu">
                                  @if (auth()->user()->hasAnyPermission(['Lista de actividades de proyectos','Ver actividades de proyecto','Crear actividades de proyecto','Editar actividades de proyecto']))
                                  ...
                                  @endif
                                  @if (auth()->user()->hasAnyPermission(['Lista de consumibles para proyectos','Ver consumibles para proyectos','Crear consumibles para proyectos','Editar consumibles para proyectos']))
                                  ...
                                  @endif
                                  @if (auth()->user()->hasAnyPermission(['Lista de materiales para proyectos','Ver materiales para proyectos','Crear materiales para proyectos','Editar materiales para proyectos']))
                                  ...
                                  @endif
                                  @if (auth()->user()->hasAnyPermission(['Lista de comisiones para técnicos de proyectos','Crear comisiones para técnicos de proyectos','Editar comisiones para técnicos de proyectos','Lista de comisiones para coordinadores de proyectos','Crear comisiones de control de proyectos','Editar comisiones de control de proyectos']))
                        ...
                        @if (auth()->user()->hasAnyPermission(['Lista de proyectos de rutas','Crear proyectos de rutas','Eliminar proyectos de rutas','Ver proyectos de rutas','Editar proyectos de rutas','Aprobar proyectos de rutas']))
                        ...
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Lista de proyectos de desmonte','Crear proyectos de desmonte','Eliminar proyectos de desmonte','Ver proyectos de desmonte','Editar proyectos de desmonte','Aprobar proyectos de desmonte']))
                        ...
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Lista de proyectos de MINTIC','Crear proyectos de MINTIC','Eliminar proyectos de MINTIC','Ver proyectos de MINTIC','Editar proyectos de MINTIC','Aprobar proyectos de MINTIC','Lista de inventarios de consumibles en bodega','Crear consumible del inventario','Editar consumible del inventario','Ver consumible del inventario','Eliminar consumible del inventario','Lista de inventarios de equipos Mintic','Crear equipo al inventario Mintic','Editar equipo al inventario Mintic','Ver equipo al inventario Mintic','Eliminar equipo al inventario Mintic','Ver implementación proyectos de MINTIC','Crear asiganción de implemetación de MINTIC','Editar asiganción de implemetación de MINTIC','Ejecutar asiganción de implemetación de MINTIC','Ver asiganción de implemetación de MINTIC','Eliminar asiganción de implemetación de MINTIC']))
                           <li class="treeview {{ activeMenu('project/mintic*') }}">
                              ...
                              <ul class="treeview-menu">
                                @if (auth()->user()->hasAnyPermission(['Lista de proyectos de MINTIC','Crear proyectos de MINTIC','Eliminar proyectos de MINTIC','Ver proyectos de MINTIC','Editar proyectos de MINTIC','Aprobar proyectos de MINTIC','Ver implementación proyectos de MINTIC','Crear asiganción de implemetación de MINTIC','Editar asiganción de implemetación de MINTIC','Ejecutar asiganción de implemetación de MINTIC','Ver asiganción de implemetación de MINTIC','Eliminar asiganción de implemetación de MINTIC']))
              ...
              <li class="treeview {{activeMenu('execution_works/inventory*')}}">
                ...
                <ul class="treeview-menu">
                  ...
                  @if (auth()->user()->hasAnyPermission(['Lista inventario de herramientas','Editar inventario de herramientas','Ver inventario de herramientas','Crear inventario de herramientas','Eliminar inventario de herramientas']))
                    <li class="{{activeMenu('execution_works/inventory/tool*')}}"><a href="{{route('inventory_tools')}}"><i class="fa fa-hammer"></i> HERRAMIENTAS</a></li>
                  @endif
                  @if (auth()->user()->hasAnyPermission(['Lista de inventarios de equipos Mintic','Crear equipo al inventario Mintic','Ver equipo al inventario Mintic','Editar equipo al inventario Mintic','Eliminar equipo al inventario Mintic']))
                  ...
                  @endif
                  @if (auth()->user()->hasAnyPermission(['Lista de inventarios de consumibles en bodega','Crear consumible del inventario','Ver consumible del inventario','Editar consumible del inventario','Eliminar consumible del inventario']))
                  ...
                  @endif
                  @if (auth()->user()->hasAnyPermission(['Ver inventario de técnicos','Editar inventario de técnicos','Lista de inventario de técnicos']))
        ...
        @if (auth()->user()->hasAnyPermission(['Crear clientes','Editar clientes','Eliminar clientes','Enviar evaluación de satisfacción del cliente','Lista de clientes','Ver clientes','Eliminar evaluación de satisfación de clientes','Lista de evaluaciones de satisfacción del cliente','Ver evaluaciones de satisfacción de los clientes']))      
              <li class="treeview {{ activeMenu('customer*')}}">
                ...
                <ul class="treeview-menu">
                  @if (auth()->user()->hasAnyPermission(['Crear clientes','Editar clientes','Eliminar clientes','Enviar evaluación de satisfacción del cliente','Lista de clientes','Ver clientes']))
                      <li class="{{ activeMenu('customers*') }}"><a class="btn-send" href="{{route('customers')}}"><i class="fa fa-user-friends"></i> CLIENTES</a></li>
                  @endif
                  @if (auth()->user()->hasAnyPermission(['Eliminar evaluación de satisfación de clientes','Lista de evaluaciones de satisfacción del cliente','Ver evaluaciones de satisfacción de los clientes']))
        ...
        @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de Inspección detallada de vehículos','Consultar inspecciones detalladas de vehículos','Descargar PDF de inspecciones detalladas de vehículos','Digitar formulario de inspección detallada de vehículos','Eliminar formato de inspecciones detalladas de vehículos','Aprobar solicitud de lista de verificación para el mantenimiento de computadores','Consultar listas de verificación para el mantenimiento de los computadores','Descargar PDF de listas de verificación para el mantenimiento de los computadores','Digitar formulario de lista de verificación para el mantenimiento de computadores','Eliminar formato de listas de verificación para el mantenimiento de los computadores','Lista de computadores del inventario','Crear computadores al inventario','Ver computadores del inventario','Editar computadores del inventario','Eliminar computadores del inventario','Lista de vehículos del inventario','Crear vehículos al inventario','Ver vehículos del inventario','Editar vehículos del inventario','Eliminar vehículos del inventario']))
            <li class="treeview {{ activeMenu('logistics_infrastructure*') }}">
              ...
              <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de Inspección detallada de vehículos','Consultar inspecciones detalladas de vehículos','Descargar PDF de inspecciones detalladas de vehículos','Digitar formulario de inspección detallada de vehículos','Eliminar formato de inspecciones detalladas de vehículos']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de lista de verificación para el mantenimiento de computadores','Consultar listas de verificación para el mantenimiento de los computadores','Descargar PDF de listas de verificación para el mantenimiento de los computadores','Digitar formulario de lista de verificación para el mantenimiento de computadores','Eliminar formato de listas de verificación para el mantenimiento de los computadores']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Lista de controles de documentos de conductores','Crear controles de documentos de conductores','Editar controles de documentos de conductores','Ver controles de documentos de conductores','Eliminar controles de documentos de conductores']))
                  <li class="{{ activeMenu('logistics_infrastructure/drivers*') }}"><a class="btn-send" href="{{ route('drivers') }}"><i class="fa fa-id-card"></i> DOCUMENTACIÓN DE CONDUCTORES</a></li>
                @endif
        ...
        @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de permiso laboral o notificación de incapacidad','Consultar permisos de trabajo','Descargar PDF de permisos de trabajo','Digitar formulario de Permisos de trabajo','Eliminar formato de permisos de trabajo','Aprobar solicitud de Inspección y protección contra caídas','Consultar inspecciones de equipos de protección contra caídas','Descargar PDF de inspecciones de equipos de protección contra caídas','Digitar formulario de Inspección de equipos de protección contra caídas','Eliminar formato de inspecciones de equipos de protección contra caídas','Aprobar solicitud de entrega de dotación personal','Consultar entrega de dotación personal','Descargar PDF de entrega de dotación personal','Digitar formulario de entrega de dotación personal','Eliminar formato de entrega de dotación personal','Aprobar solicitud de Permisos de trabajo','Consultar solicitud de permisos laborales o notificaciones de incapacidad médica','Descargar PDF de solicitud de permisos laborales o notificaciones de incapacidad médica','Digitar formulario de solicitud de permiso laboral o notificación de incapacidad','Eliminar formato de solicitud de permisos laborales o notificaciones de incapacidad médica','Aprobar evaluación de desempeño','Calificar evaluaciones de desempeño','Disparar evaluación de desempeño','Evaluar evaluaciones de desempeño','Lista de evaluaciones de desempeño','Ver evaluaciones de desempeño','Aprobar llamados de atención','Editar llamados de atención','Eliminar llamados de atención','Lista de llamados de atención','Realizar llamados de atención a trabajadores','Responder llamados de atención','Ver llamados de atención','Crear memorandos','Editar memorandos','Eliminar memorandos','Lista de memorandos','Ver memorandos','Aprobar entrevistas','Crear entrevistas','Editar entrevistas','Eliminar entrevistas','Lista de entrevista','Ver entrevistas','Aprobar hojas de vida','Crear hojas de vida','Editar hojas de vida','Eliminar hojas de vida','Lista de hojas de vida','Ver hojas de vida','Eliminar solicitudes de empleo','Lista de solicitudes de empleo','Ver solicitudes de empleo']))
            <li class="treeview {{ activeMenu('human_management*') }}{{ activeMenu('show_called*') }}{{ activeMenu('attention_call*') }}{{ activeMenu('job_application*') }}{{ activeMenu('performance_evaluation*') }}{{ activeMenu('curriculum*') }}">
              ...
              <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de permiso laboral o notificación de incapacidad','Consultar permisos de trabajo','Descargar PDF de permisos de trabajo','Digitar formulario de Permisos de trabajo','Eliminar formato de permisos de trabajo','Aprobar solicitud de Inspección y protección contra caídas','Consultar inspecciones de equipos de protección contra caídas','Descargar PDF de inspecciones de equipos de protección contra caídas','Digitar formulario de Inspección de equipos de protección contra caídas','Eliminar formato de inspecciones de equipos de protección contra caídas','Aprobar solicitud de entrega de dotación personal','Consultar entrega de dotación personal','Descargar PDF de entrega de dotación personal','Digitar formulario de entrega de dotación personal','Eliminar formato de entrega de dotación personal','Aprobar solicitud de Permisos de trabajo','Consultar solicitud de permisos laborales o notificaciones de incapacidad médica','Descargar PDF de solicitud de permisos laborales o notificaciones de incapacidad médica','Digitar formulario de solicitud de permiso laboral o notificación de incapacidad','Eliminar formato de solicitud de permisos laborales o notificaciones de incapacidad médica']))
                    <li class="treeview {{ activeMenu('human_management/proceeding*') }}{{ activeMenu('human_management/work_permit*') }}{{ activeMenu('human_management/fall_protection_equipment_inspection*') }}{{ activeMenu('human_management/delivery_staffing*') }}{{ activeMenu('human_management/work_permits_notifications_medical_incapacity*') }}{{activeMenu('human_management/improvement_action*')}}">
                      ...
                      <ul class="treeview-menu">
                        ...
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de Inspección y protección contra caídas','Consultar inspecciones de equipos de protección contra caídas','Descargar PDF de inspecciones de equipos de protección contra caídas','Digitar formulario de Inspección de equipos de protección contra caídas','Eliminar formato de inspecciones de equipos de protección contra caídas']))
                        ...
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Aprobar solicitud de entrega de dotación personal','Consultar entrega de dotación personal','Descargar PDF de entrega de dotación personal','Digitar formulario de entrega de dotación personal','Eliminar formato de entrega de dotación personal']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Aprobar llamados de atención','Editar llamados de atención','Eliminar llamados de atención','Lista de llamados de atención','Realizar llamados de atención a trabajadores','Responder llamados de atención','Ver llamados de atención']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Eliminar solicitudes de empleo','Lista de solicitudes de empleo','Ver solicitudes de empleo']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Aprobar retiro de cesantías','Consultar retiro de cesantías','Digitar solicitud de retiro de cesantías','Eliminar solicitud de retiro de cesantías']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Tomar asistencia','Ver asistencia','Lista de asistencias','Eliminar asistencia','Editar asistencia']))  
        ...
        @endif
        {{-- DOCUMENTOS --}}
        @if (auth()->user()->hasAnyPermission(['Crear documentos','Descargar documentos','Editar documentos','Eliminar documentos','Lista de documentos','Ver documentos']))
        ...
        @if (auth()->user()->hasAnyPermission(['Crear usuarios','Editar usuarios','Eliminar usuarios','Exportar usuarios a excel','Lista de usuarios','Ver usuarios','Restaurar usuarios eliminados','Ver usuarios eliminados','Crear roles','Editar roles','Eliminar roles','Lista de roles']))
            <li class="treeview {{ activeMenu('roles*') }} {{ activeMenu('retired*') }} {{ activeMenu('users*') }}">
              ...
              <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['Crear usuarios','Editar usuarios','Eliminar usuarios','Exportar usuarios a excel','Lista de usuarios','Ver usuarios']))
              ...
              <ul class="treeview-menu">
                ...
                @if (auth()->user()->hasAnyPermission(['Crear documentos para la cartelera','Editar documentos de la cartelera','Eliminar documentos de la cartelera','Lista de tipos de cartelera','Crear tipos de cartelera','Ver tipos de cartelera','Editar tipos de cartelera','Eliminar tipos de cartelera']))
                    <li class="treeview {{ activeMenu('billboard*') }}">
                      ...
                      <ul class="treeview-menu">
                        @if (auth()->user()->hasAnyPermission(['Crear documentos para la cartelera','Editar documentos de la cartelera','Eliminar documentos de la cartelera']))
                            <li class="{{ activeMenu('billboards*') }}"><a class="btn-send" href="{{ route('billboard') }}"><i class="fa fa-folder-open"></i> DOCUMENTOS</a></li>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Lista de tipos de cartelera','Crear tipos de cartelera','Ver tipos de cartelera','Editar tipos de cartelera','Eliminar tipos de cartelera']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['Lista de lesiones aprendidas','Crear lesiones aprendidas','Editar lesiones aprendidas','Eliminar lesiones aprendidas','Ver lesiones aprendidas','Lista de preguntas de lesiones aprendidas','Crear preguntas de lesiones aprendidas','Editar preguntas de lesiones aprendidas','Eliminar preguntas de lesiones aprendidas','Ver preguntas de lesiones aprendidas']))
                    ...
                    <ul class="treeview-menu">
                        @if (auth()->user()->hasAnyPermission(['Lista de lesiones aprendidas','Crear lesiones aprendidas','Editar lesiones aprendidas','Eliminar lesiones aprendidas','Ver lesiones aprendidas']))
                            <li class="{{ activeMenu('learned_lessons*') }}"><a class="btn-send" href="{{route('learned_lessons')}}"><i class="fa fa-crutch"></i> REGISTROS</a></li>
                        @endif
                        @if (auth()->user()->hasAnyPermission(['Lista de preguntas de lesiones aprendidas','Crear preguntas de lesiones aprendidas','Editar preguntas de lesiones aprendidas','Eliminar preguntas de lesiones aprendidas','Ver preguntas de lesiones aprendidas']))
        ...
        @endif
        {{-- CVS --}}
        @if (auth()->user()->hasAnyPermission(['CVS Exportar reporte de ventas','CVS Lista de ventas','CVS Crear ventas','CVS Ver ventas','CVS Finalizar ventas','CVS Cancelar ventas','CVS Pagar recibos','CVS Cancelar ventas','CVS Ver clientes','CVS Lista de móviles','CVS Crear móviles','CVS Ver móviles','CVS Editar móviles','CVS Lista de sim cards','CVS Crear sim cards','CVS Ver sim cards','CVS Editar sim cards','CVS Lista de accesorios','CVS Crear accesorios','CVS Ver accesorios','CVS Lista de recibos por pagar','CVS Editar accesorios','CVS Lista de sedes','CVS Crear sedes','CVS Ver sedes','CVS Editar sedes','CVS Lista de tipos de sim cards','CVS Crear tipos de sim cards','CVS Ver tipos de sim cards','CVS Editar tipos de sim cards','CVS Lista de activaciones','CVS Crear activaciones','CVS Ver activaciones','CVS Editar activaciones','CVS Lista de categoría de accesorios','CVS Crear categoría de accesorios','CVS Ver categoría de accesorios','CVS Editar categoría de accesorios','CVS Lista de publicidades','CVS Crear publicidades','CVS Ver publicidades','CVS Editar ventas','CVS Lista de servicios Claro','CVS Crear servicios Claro','CVS Ver servicios Claro','CVS Editar servicios Claro','CVS Editar publicidades','CVS Eliminar móviles','CVS Eliminar sim cards','CVS Eliminar servicios Claro','CVS Eliminar accesorios']))
          <li class="treeview {{ activeMenu('cvs*') }} {{ activeMenu('cvs*') }} {{ activeMenu('cvs*') }}">
            ...
            <ul class="treeview-menu">
              @if (auth()->user()->hasAnyPermission(['CVS Lista de ventas','CVS Exportar reporte de ventas','CVS Crear ventas','CVS Ver ventas','CVS Editar ventas','CVS Finalizar ventas','CVS Cancelar ventas']))
              ...
              @endif
              @if (auth()->user()->hasAnyPermission(['CVS Lista de móviles','CVS Crear móviles','CVS Ver móviles','CVS Editar móviles','CVS Lista de sim cards','CVS Crear sim cards','CVS Ver sim cards','CVS Editar sim cards','CVS Lista de accesorios','CVS Crear accesorios','CVS Ver accesorios','CVS Lista de servicios Claro','CVS Crear servicios Claro','CVS Ver servicios Claro','CVS Editar servicios Claro','CVS Editar accesorios','CVS Eliminar móviles','CVS Eliminar sim cards','CVS Eliminar servicios Claro','CVS Eliminar accesorios']))
                  <li class="treeview {{ activeMenu('cvs/inventary*') }}">
                    ...
                    <ul class="treeview-menu">
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de móviles','CVS Crear móviles','CVS Ver móviles','CVS Editar móviles','CVS Eliminar móviles']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de sim cards','CVS Crear sim cards','CVS Ver sim cards','CVS Editar sim cards','CVS Eliminar sim cards']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de accesorios','CVS Crear accesorios','CVS Ver accesorios','CVS Editar accesorios','CVS Eliminar servicios Claro']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de servicios Claro','CVS Crear servicios Claro','CVS Ver servicios Claro','CVS Editar servicios Claro','CVS Eliminar accesorios']))
              ...
              @endif
              @if (auth()->user()->hasAnyPermission(['CVS Lista de sedes','CVS Crear sedes','CVS Ver sedes','CVS Editar sedes','CVS Lista de tipos de sim cards','CVS Crear tipos de sim cards','CVS Ver tipos de sim cards','CVS Editar tipos de sim cards','CVS Lista de activaciones','CVS Crear activaciones','CVS Ver activaciones','CVS Editar activaciones','CVS Lista de categoría de accesorios','CVS Crear categoría de accesorios','CVS Ver categoría de accesorios','CVS Editar categoría de accesorios','CVS Lista de publicidades','CVS Crear publicidades','CVS Ver publicidades','CVS Editar publicidades']))
                  <li class="treeview {{ activeMenu('cvs/admin*') }}">
                    ...
                    <ul class="treeview-menu">
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de tipos de sim cards','CVS Crear tipos de sim cards','CVS Ver tipos de sim cards','CVS Editar tipos de sim cards']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de activaciones','CVS Crear activaciones','CVS Ver activaciones','CVS Editar activaciones']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de categoría de accesorios','CVS Crear categoría de accesorios','CVS Ver categoría de accesorios','CVS Editar categoría de accesorios']))
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CVS Lista de publicidades','CVS Crear publicidades','CVS Ver publicidades','CVS Editar publicidades']))
        ...
        @endif
        {{-- CCJL --}}
        @if (auth()->user()->hasAnyPermission(['CCJL Crear rentas','CCJL Lista de rentas','CCJL Ver rentas','CCJL Editar rentas','CCJL Pagar rentas','CCJL Recordar pago de rentas','CCJL Lista de clientes','CCJL Ver clientes','CCJL Editar clientes','CCJL Lista de canons','CCJL Ver canons','CCJL Editar canons','CCJL Crear servicios','CCJL Lista de servicios','CCJL Ver servicios','CCJL Editar servicios','CCJL Crear administraciones','CCJL Lista de administraciones','CCJL Ver administraciones','CCJL Editar Administraciones']))
            <li class="treeview {{ activeMenu('ccjl*') }}">
              ...
              <ul class="treeview-menu">
                @if (auth()->user()->hasAnyPermission(['CCJL Lista de rentas','CCJL Crear rentas','CCJL Ver rentas','CCJL Pagar rentas','CCJL Recordar pago de rentas','CCJL Editar rentas']))
                ...
                @endif
                @if (auth()->user()->hasAnyPermission(['CCJL Lista de canons','CCJL Ver canons','CCJL Editar canons','CCJL Lista de servicios','CCJL Crear servicios','CCJL Ver servicios','CCJL Editar servicios','CCJL Lista de administraciones','CCJL Crear administraciones','CCJL Ver administraciones','CCJL Editar Administraciones']))
                  <li class="treeview {{ activeMenu('ccjl/local*') }} {{ activeMenu('ccjl/service*') }} {{ activeMenu('ccjl/administration*') }}">
                    ...
                    <ul class="treeview-menu">
                      ...
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CCJL Lista de servicios','CCJL Crear servicios','CCJL Ver servicios','CCJL Editar servicios']))
                          <li class="{{ activeMenu('ccjl/service*') }}"><a class="btn-send" href="{{ route('CCJL_services') }}"><i class="fa fa-server"></i> SERVICIOS</a></li>
                      @endif
                      @if (auth()->user()->hasAnyPermission(['CCJL Lista de administraciones','CCJL Crear administraciones','CCJL Ver administraciones','CCJL Editar Administraciones']))
