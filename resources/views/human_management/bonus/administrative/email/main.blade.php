                                ...
                                <tr>
                                    ...
                                    <p
                                        ...
                                        <table class="table-form">
                                            ...
                                            <tbody>
                                                @foreach ($id->users as $key => $item)
                                                    <tr>
                                                        <td>{{ $item->user->cedula }}</td>
                                                        <td>{{ $item->user->name }}</td>
                                                        <td>{{ $item->user->register->bank_account }}</td>
                                                        <td class="text-right">${{ number_format($item->total_user,2,',','.') }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
