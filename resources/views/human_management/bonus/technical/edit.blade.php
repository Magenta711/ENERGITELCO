                        ...
                        <tbody>
                            @foreach ($items as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item['name'] }}</td>
                                    <td>
                                        <input type="hidden" name="work_id[{{ $key }}]" value="{{ $item['id'] }}">
                                        <input type="hidden" name="position[{{ $key }}]" value="{{ $item['position'] }}">
                                        <input type="number" name="bonus[{{ $key }}]" id="bonus_{{ $key }}" value="{{ $item['bonus'] ?? 0 }}" class="form-control text-right">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
