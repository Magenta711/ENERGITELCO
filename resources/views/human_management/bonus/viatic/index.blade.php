                            ...
                            <tr>
                                ...
                                <td>
                                    @can('Ver bonificaciones de permisos de trabajo')
                                        <a href="{{ route('work_permit_viatics_show',$item->id) }}" class="btn btn-sm btn-success">Ver</a>
                                    @endcan
                                    @can('Editar bonificaciones de permisos de trabajo')
                                        @if ($item->status == 3 || $item->status == 2)
                                            <a href="{{ route('work_permit_viatics_edit',$item->id) }}" class="btn btn-sm btn-primary">Editar</a>
                                        @endif
                                    @endcan
                                    @if ($item->status == 1)
