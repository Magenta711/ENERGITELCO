                            ...
                            <table class="inner-body" align="center" width="750" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 750px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 750px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">{{$format->estado == 'Aprobado' ? 'Estás recibiendo una solicitud de permiso de trabajo aprobada' : 'Estás recibiendo una solicitud de permiso de trabajo para su aprobación.'}}</p>
                                        ...
                                        <table class="table-form">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($format->users as $usuario)
                                                <tr>
                                                    <td>
                                                        {{$usuario->cedula}}
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b1u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b2u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b3u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b4u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b5u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2b6u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2c1u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2c2u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2c4u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f2c3u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th colspan="5">
                                                ...
                                                <tr>
                                                    <th colspan="2">Nombre del representante del trablajo o líder</th>
                                                    <td>{{ $format->responsableAcargo->name }}</td>
                                                    <th>Cédula</th>
                                                    <td>{{ $format->responsableAcargo->cedula }}</td>
                                                </tr>
                                                @if ($format->estado == 'Aprobado')
                                                    <tr>
                                                        <th colspan="2">Nombre del auditor o coordinador</th>
                                                        <td>{{ $format->coordinadorAcargo->name }}</td>
                                                        <th>Cédula</th>
                                                        <td>{{ $format->coordinadorAcargo->cedula }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="2">Fecha validez permiso</th>
                                                        <td>{{ $format->fecha_validez_permiso }}</td>
                                                        <th>Hora validez</th>
                                                        <td>{{ $format->hora_inicio }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="2">Fecha final de la validez</th>
                                                        <td>{{ $format->fecha_validez_permiso }}</td>
                                                        <th>Hora validez</th>
                                                        <td>{{ $format->hora_final }}</td>
                                                    </tr>
                                                @endif
                                                <tr>
                                                    <th>4</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f6a1u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comentarios</td>
                                                    <td colspan="4">{{$format->comentario1}}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Coderas
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f6a2u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comentarios</td>
                                                    <td colspan="4">{{$format->comentario2}}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Rodilleras
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f6a3u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comentarios</td>
                                                    <td colspan="4">{{$format->comentario3}}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Impermeable
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f6a4u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comentarios</td>
                                                    <td colspan="4">{{$format->comentario4}}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{$format->work_add ? $format->work_add->f6a5u4 : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Comentarios</td>
                                                    <td colspan="4">{{$format->comentario5}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>Nombre</td>
                                                    <td>{{$format->estado == 'Aprobado' ? $format->coordinadorAcargo->name : ''}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Cédula</td>
                                                    <td>{{$format->responsableAcargo->cedula}}</td>
                                                    <td></td>
                                                    <td>Cédula</td>
                                                    <td>{{$format->estado == 'Aprobado' ? $format->coordinadorAcargo->cedula : '' }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                @if ($format->created_at <= '2021-12-10 24:00:00')
                                                    <tr>
                                                        <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a2u1,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a2u2,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a2u3,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a2u4,2,',','.') : ''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a3u1,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a3u2,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a3u3,2,',','.') : ''}}
                                                    </td>
                                                    <td class="text-right">
                                                        {{($format->work_add) ? '$'.number_format($format->work_add->f9a3u4,2,',','.') : ''}}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
