...
<section class="content-header">
    <h1>
        EDITAR REPORTE DE NOVEDADES DE NOMINA Y HORAS EXTRAS
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="box">
                <form action="{{ route('payroll_overtime_news_report_update',$id->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="box-body">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="value_assistance" value="{{ $id->value_assistance }}" id="value_assistance" class="inputs_general form-control">
                        </div>
                    </div>
                    <hr>
                    <div class="box-group" id="accordion">
                        @include('human_management.payroll_over_time.includes.form1_edit')
                    </div>
                </div>
