                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Se ha generado un comprobate de pago de liquidación por prestaciones sociales de {{auth()->user()->name}}, de clic en el botón para descargar
                                        </p>
                                        <div style="display: flex; width: 100%">
                                            <div style="width: 25%; text-align: center">
                                                <p>Liquidación de cesantías <br>${{number_format($id->total_linkend,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Pago de intereses de cesantías <br>${{number_format($id->intereses,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Liquidación por prima <br>${{number_format($id->total_premium,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Pago de vacaciones <br>${{number_format($id->total_vacation,2,',','.')}}</p>
                                            </div>
                                        </div>
                                        <div style="display: flex; width: 100%">
                                            <div style="width: 25%; text-align: center">
                                                <p>Salario pendiente <br>${{number_format($id->this_salary,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Pago de indemnización <br>${{number_format($id->compensation,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Deudas con la compañía <br>${{number_format($id->debt,2,',','.')}}</p>
                                            </div>
                                            <div style="width: 25%; text-align: center">
                                                <p>Total a pagar por liquidación <br>${{number_format($id->total_settlement,2,',','.')}}</p>
                                            </div>
                                        </div>
