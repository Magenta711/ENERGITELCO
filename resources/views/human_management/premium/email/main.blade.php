                            ...
                            <table class="inner-body" align="center" width="800" cellpadding="0" cellspacing="0" role="presentation" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 800px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 800px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; padding: 35px;">
                                        ...
                                        <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Estás recibiendo un corte de prima de servicios.</p>
                                            ...
                                            <table class="table-form">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="3">Firmado electrónicamente por quién solicita la solicitud</td>
                                                        <td colspan="3">Firmado electrónicamente de quién aprueba la solicitud</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1">Nombre</td>
                                                        <td colspan="2">{{ $format->responsable->name }}</td>
                                                        <td colspan="1">Nombre</td>
                                                        <td colspan="2">
                                                            {{ $format->approve ? $format->approve->name : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1">Cédula</td>
                                                        <td colspan="2">{{ $format->responsable->cedula }}</td>
                                                        <td colspan="1">Cédula</td>
                                                        <td colspan="2">
                                                            {{ $format->approve ? $format->approve->cedula : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
                                                            Solicitud elaborada inicialmente y firmada electrónicamente por <strong>{{ $format->responsable->name }}</strong>, en rol de {{ $format->responsable->getRoleNames()[0] }} habilitado por Energitelco, con conocimiento de funciones y contenido del presente documento. Se cumple Ley 527 de 1999 y Decreto 19 de 2012
                                                        </td>
                                                        <td colspan="3">
                                                            @if ($format->approve)
                                                                Solicitud aprobada y firmada electrónicamente por <strong>{{ $format->approve->name }}</strong> en rol de {{ $format->approve->getRoleNames()[0] }} Energitelco, con conocimiento de funciones y contenido del presente documento. Se cumple Ley 527 de 1999 y Decreto 19 de 2012
                                                            @endif
                                                        </td>
                                                    </tr>
                                                </tbody>
