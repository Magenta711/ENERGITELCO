            ...
            Energitelco
                ...
                <table class="table-form">
                    <tbody>
                        <tr>
                            <th>TRABAJADOR:</th>
                            <td>{{$format->trabajador->name}}</td>
                        </tr>
                        <tr>
                            <th>CÉDULA:</th>
                            <td>{{$format->trabajador->cedula}}</td>
                        </tr>
                        <tr>
                            <th>CARGO:</th>
                            <td>{{$format->trabajador->position->name}}</td>
                        </tr>
                        <tr>
                            <th>AREA:</th>
                            <td>{{$format->trabajador->area}}</td>
                        </tr>
                    </tbody>
                </table>
                <table class="table-form">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$format->fecha_inicio}} {{$format->hora_inicio}} </td>
                            <td>{{$format->fecha_finalizacion}} {{$format->hora_finalizacion}} </td>
                        </tr>
                    </tbody>
                </table>
                <p><strong>Tipo de solicitud:</strong> {{$format->tipo_solicitud}}</p>
                <table class="table-form">
                    <thead>
                        <tr>
                ...
                <table class="table-form">
                    ...
                    <tbody>
                        <tr>
                            <td>{{$format->observaciones_jefe}}</td>
                        </tr>
                    </tbody>
                </table>
                @endif
