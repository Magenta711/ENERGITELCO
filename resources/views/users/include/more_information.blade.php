            ...
            <div class="tab-pane" id="forms">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                            ...
                            <li><a href="#tab_7-2" data-toggle="tab">Solicitud de permiso laboral o notificación de incapacidad médica
                                <span class="label label-primary">{{count($id->works7)}}</span></a></li>
                       
                        
                            <li><a href="#tab_6-2" data-toggle="tab">Lista de verificación para el mantenimiento de los computadores
                                <span class="label label-primary">{{count($id->works6)}}</span></a></li>
                       
                        
                            <li><a href="#tab_5-2" data-toggle="tab">Entrega de dotación personal
                                <span class="label label-primary">{{count($id->works5)}}</span></a></li>
                       
                        
                            <li><a href="#tab_4-2" data-toggle="tab">Revisión y asignación de herramientas
                                <span class="label label-primary">{{count($id->works4)}}</span></a></li>
                       
                        
                            <li><a href="#ta_3-2"b data-toggle="tab">Inspección detallada de vehículos
                                <span class="label label-primary">{{count($id->works3)}}</span></a></li>
                       
                        
                            <li><a href="#tab_2-2" data-toggle="tab">Inspección y protección contra caídas
                                <span class="label label-primary">{{count($id->works2)}}</span></a></li>
                       
                        
                            <li class="active"><a href="#tab_1-1" data-toggle="tab">Permisos de trabajo
                                <span class="label label-primary">{{count($id->works1)}}</span></a></li>
