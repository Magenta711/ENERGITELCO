                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 @error('password') has-error @enderror">
                                    <input id="password" type="password" class="form-control" name="password"
                                        autocomplete="off-password" placeholder="{{ __('Password') }}">
                                    @error('password')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 @error('roles') has-error @enderror">
                                    <select name="roles" id="rol" class="form-control" placeholder="Rol">
                                        ...
                                        @foreach ($roles as $rol)
                                            <option {{ old('roles') == $rol->id ? 'selected' : '' }}
                                                {{ !auth()->user()->hasRole('Administrador') && $rol->id == 1? 'disabled': '' }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 @error('cedula') has-error @enderror">
                                    <input id="cedula" type="text" class="form-control" name="cedula"
                                        value="{{ old('cedula') }}" autocomplete="off" placeholder="Número de documento">
                                    @error('cedula')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 @error('area') has-error @enderror">
                                    <input id="area" type="text" class="form-control" name="area"
                                        value="{{ old('area') }}" autocomplete="off" placeholder="Área">
                                    @error('area')
                                        <span class="help-block">{{ $message }}</span>
                                    @enderror
                                </div>
