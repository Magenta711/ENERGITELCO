...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <form action="{{ route('mintic_installation_update', [$id, $item->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="group_install" value="{{ $item->group_install }}" name="group_install" id="group_install"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="dane_depa" id="dane_depa"
                                    class="form-control" value="{{ $item->dane_depa }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="dane_muni" id="dane_muni"
                                    class="form-control" value="{{ $item->dane_muni }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="dane_centro" id="dane_centro"
                                    class="form-control" value="{{ $item->dane_centro }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="dane_sede" id="dane_sede"
                                    class="form-control" value="{{ $item->dane_sede }}">
                            </div>
                        </div>
                        </div>
                        <h3>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="responsable_name" id="responsable_name"
                                    value="{{ $item->responsable_name }}" class="form-control">
                                    <small></small>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="responsable_dni" id="responsable_dni"
                                    class="form-control" value="{{ $item->responsable_dni }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="responsable_number" id="responsable_number"
                                    value="{{ $id->responsable_number }}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea value="{{ $item->fault_description }}" name="fault_description" id="fault_description" cols="30"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $item->repair_cc }}" name="repair_cc"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $item->repair_tel }}" name="repair_tel"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $item->repair_mail }}" name="repair_mail"
