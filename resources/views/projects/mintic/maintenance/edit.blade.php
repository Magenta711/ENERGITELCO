    ...
    <div class="hidden">
        @foreach ($user_equipments as $equipment)
            @if ($equipment->inventaryble->equip)
                <p> {{$equipment->inventaryble->id}}, {{$equipment->inventaryble->serial}}, {{$equipment->inventaryble->item}}</p>
                <input type="hidden" id="serial_user_equipment_{{$equipment->inventaryble->equip->id}}" value="{{$equipment->inventaryble->serial}}">
            @endif
        @endforeach
    </div>
            ...
            <form action="{{ route('mintic_maintenance_update', [$id, $item->id]) }}" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div id="destino_retired">
                        ...
                        @foreach ($item->equipments as $equipment_item)
                            @if ($equipment_item->type == 'retired')
                                ...
                                <div class="row" id="origen_retired">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="detail_retired_{{$equipment_item->id}}">Detalle</label>
                                            <select name="detail_retired[]" id="detail_retired_{{$equipment_item->id}}"
                        ...
                        {{-- <p>{{ $equipment->sap }} -
                            {{ $equipment->name }} - {{ $equipment->model_id }} -
                            {{ $equipment->part_id }} - {{ $equipment->brand }}</p> --}}
                        @if (!$retired)
                            <div class="row" id="origen_retired">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        @foreach ($item->equipments as $equipment_item)
                            @if ($equipment_item->type == 'install')
                                ...
                                <div class="row" id="origen_install">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="detail_install_{{$equipment_item->id}}">Detalle con 1</label>
                                            <select name="detail_install[]" id="detail_install_{{$equipment_item->id}}"
                                                ...
                                                @foreach ($user_equipments as $equipment)
                                                    @if ($equipment->inventaryble->equip)
                                                        <option
                                                            {{ $equipment_item->detail_id == $equipment->inventaryble->equip->id ? 'selected' : '' }}
