    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools">
                    @can('Editar parada de reloj de proyecto MinTIC')
                        ...
                        <tbody>
                            @foreach ($id->stop_clocks as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->date }}</td>
                                    <td>
                                        {{ $item->status == 1 ? 'Aprobado' : ($item->status == 0 ? 'Sin aprobar' : 'No aprobado') }}
                                    </td>
                                    <td>
                                        @can('Ver parada de reloj de proyecto MinTIC')
