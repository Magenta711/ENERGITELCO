<table>
    ...
    <tr>
        <td></td>
        <td colspan="15" style="text-align: center; background: #A6A6A6">5. REGISTRO FOTOGRÁFICO</td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td colspan="15" style="text-align: center; background: #A6A6A6">6. OBSERVACIONES</td>
    </tr>
    <tr>
        <td></td>
        <td colspan="15"></td>
