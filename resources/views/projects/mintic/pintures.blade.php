        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '2',
                    'label' =>
                        'Lugar donde se instalará la antena, foto con brújula donde se vea el azimut a la escuela',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '3',
                    'label' =>
                        'Objetos que puedan estar bloqueando  la línea de vista como árboles y edificios, especificar la altura.',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Fotos del gabinete de microondas donde se encuentra el radio o el alcatel donde se conectara el servicio',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Fotos del recorrido del cable que va del radio hasta la antena MW, pero solo a nivel de piso',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
