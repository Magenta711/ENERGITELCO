        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Captura de las coordenadas geográficas arrojadas por GPS con mínimo 5 cifras decimales',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '6',
                    'label' =>
                        'DISPOSITIVO MÓVIL CONECTADO AL PUNTO DE ACCESO INALÁMBRICO EXTERIOR DEL CENTRO DIGITAL',
                    'description' =>
                        'Registro fotográfico o captura de pantalla de un equipo móvil conectado a la red wifi exterior del centro digital, collage de imágenes donde se evidencie contexto y la segunda evidencie la navegación',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Registro fotográfico de la socialización a los Encargados de la Institución Pública',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Registro fotográfico de la solución de respaldo, Aplica siempre y cuando no se instale una solución alternativa',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Registro fotográfico de Solución Alternativa de Energía aplica para los sitios donde se instala, para el caso de uso de paneles solares realizar collage de imágenes que evidencien los equipos ',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Registro fotográfico de la cobertura wifi del access point Interior AP Interior',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'description' =>
                        'Registro fotográfico de la cobertura wifi del access point exterior AP1 y AP 2, si los AP están instalados en zonas diferentes hacer un collage de imágenes',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '17',
                    'label' =>
                        'VIDEO OMNIDIRECCIONAL (360°), ÁREA CUBIERTA POR EL PUNTO DE ACCESO INALÁMBRICO WIFI INTERIOR (eje horizontal)',
                    'description' =>
                        'Video omnidireccional de la cobertura del access point interior, la duración del video es de mínimo 30 segundos, tener en cuenta una altura que permita observar la zona de cobertura',
                    'accept' => 'video/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '18',
                    'label' =>
                        'VIDEO OMNIDIRECCIONAL (360°), ÁREA CUBIERTA POR EL PUNTO DE ACCESO INALÁMBRICO WIFI EXTERIOR AP 1 O AP1 Y AP2 (eje horizontal)',
                    'description' =>
                        'Video omnidireccional de la cobertura del access point exterior, la duración del video es de mínimo 30 segundos, tener en cuenta una altura que permita observar la zona de cobertura',
                    'accept' => 'video/*',
                ])
                <hr>
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '19',
                    'label' =>
                        'VIDEO OMNIDIRECCIONAL (360°), ÁREA CUBIERTA POR EL PUNTO DE ACCESO INALÁMBRICO WIFI EXTERIOR  AP 2 (eje horizontal) SI APLICA',
                    'description' =>
                        'Video omnidireccional de la cobertura del access point exterior, la duración del video es de mínimo 30 segundos, tener en cuenta una altura que permita observar la zona de cobertura',
                    'accept' => 'video/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '2',
                    'label' =>
                        'Al finalizar la instalación, entrega de video al rector y estudiantes, comunidad aledaña se le entregan volantes. FOTO',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                <hr>
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '3',
                    'label' =>
                        'Registro Fotográfico o pantallazo de ingreso a portal cautivo (usuario nuevo), que contenga nombre del centro poblado, Municipio donde está instalado el, centro digital',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '5',
                    'label' =>
                        'Registro Fotográfico solución para conectividad (antena radio enlace, antena satelital o solución de fibra óptica)',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '7',
                    'label' =>
                        'Registro Fotográfico o pantallazo de ingreso a portal cautivo (usuario nuevo), que contenga nombre del centro poblado, Municipio y Sede Educativa donde está instalado el centro digital.',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '7',
                    'label' =>
                        'Registro Fotográfico o pantallazo de ingreso a portal cautivo (usuario recurrente, es decir inicio de una nueva sesión del mismo usuario), para validar la experiencia del usuario.',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '8',
                    'label' =>
                        'Registro Fotográfico o pantallazos de las pruebas para verificar concurrencia de mínimo 10 usuarios',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '9',
                    'label' =>
                        'Registro Fotográfico de mediciones de voltaje en tablero secundario (especificados en el formato de visita).',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '10',
                    'label' =>
                        'Registro Fotográfico de medición del voltaje en el tablero entre Neutro y tierra (< ó = 1 Voltio)',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
                ...
                @include('projects.mintic.includes.upload', [
                    ...
                    'it' => '12',
                    'label' =>
                        'Registro Fotográfico del sistema de respaldo aplica solo para solución eléctrica interconectada',
                    'energy_measurement' => '2',
                    'date_edit' => true,
                    'accept' => 'image/*',
                ])
