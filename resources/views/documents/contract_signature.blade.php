...
<body>
    ...
    <main class="text-justify">
        ...
        <div class="info_user">
            <p>NOMBRE: {{$id->name}} </p>
            <p>LUGAR DE RESIDENCIA: {{$id->place_residence}}</p>
            <p>DIRECCIÓN: {{$id->address}}</p>
            <p>BARRIO: {{$id->neighborhood}}</p>
            <p>FECHA DE NACIMIENTO: {{$id->date_birth}}</p>
        </div>
        <p>NACIONALIDAD: {{$id->nationality}}</p>
        ...
        <p>FIRMAS:</p><br>
        <P>
            Firmada electrónicamente por <b>JORGE ANDRES ORTEGA BEDOYA</b> en rol de gerente general habilitado por Energitelco, con conocimiento de funciones y contenido del presente documento. Se cumple Ley 527 de 1999 y Decreto 19 de 2012
        </P>
        <hr>
            <p>
        ...
        <br><br><br><br>
        <p>FIRMADO ELECTRONICAMENTE POR EL TRABAJADOR</p><br>
        <p>
            Firmada electrónicamente por <strong>{{$id->user->name}}</strong>, en rol de {{$id->user->getRoleNames()[0]}}  habilitado por Energitelco, con conocimiento de funciones y contenido del presente documento. Se cumple Ley 527 de 1999 y Decreto 19 de 2012
        </p>
        <hr>
        <p>
            NOMBRE: {{ $id->user->name }}
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            CÉDULA NRO: {{ $id->user->cedula }}
        </p>
    </main>
