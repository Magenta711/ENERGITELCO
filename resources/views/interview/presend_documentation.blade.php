            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="place_residence" value="{{$id->register->place_residence}}" id="place_residence" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="neighborhood">Barrio</label>
                        <input type="text" name="neighborhood" value="{{$id->register->neighborhood}}" id="neighborhood" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="date_birth">Fecha de nacimiento</label>
                        <input type="date" name="date_birth" value="{{$id->register->date_birth}}" id="date_birth" class="form-control">
                    </div>
                    <div class="col-md-3">
                        <label for="nationality">Nacionalidad</label>
                        <input type="text" name="nationality" value="{{$id->register->nationality}}" id="nationality" class="form-control">
                    </div>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <br>
                        <label>
                            <input type="radio" {{ (old('type_contract') == 'Definido' ) ? 'checked' : '' }} name="type_contract" id="option1" value="Definido" class="type_contract"> Definido
                        </label>
                        <label>
                            <input type="radio" {{ (old('type_contract') == 'Indefinido' ) ? 'checked' : '' }} name="type_contract" id="option2" value="Indefinido" class="type_contract"> Indefinido
                        </label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group hide" id="div_months">
                        ...
                        <input type="number" name="months" value="{{old('months')}}" id="months" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <select name="day_breack" id="day_breack" class="form-control">
                        <option selected disabled></option>
                        <option {{(old('day_breack') == 'Lunes') ? 'selected' : ''}} value="Lunes">Lunes</option>
                        <option {{(old('day_breack') == 'Martes') ? 'selected' : ''}} value="Martes">Martes</option>
                        <option {{(old('day_breack') == 'Miercoles') ? 'selected' : ''}} value="Miercoles">Miercoles</option>
                        <option {{(old('day_breack') == 'Jueves') ? 'selected' : ''}} value="Jueves">Jueves</option>
                        <option {{(old('day_breack') == 'Viernes') ? 'selected' : ''}} value="Viernes">Viernes</option>
                        <option {{(old('day_breack') == 'Sabado') ? 'selected' : ''}} value="Sabado">Sabado</option>
                        <option {{(old('day_breack') == 'Domingo') ? 'selected' : ''}} value="Domingo">Domingo</option>
                    </select>
                </div>
            </div>
        </div>
