...
<table class="table-form">
    ...
    <tbody>
        <tr>
            ...
            <th colspan="2">Nombre del funcionario</th>
        </tr>
        <tr>
            <td class="text-center" colspan="2">{{$format->empleado->cedula}}</td>
            <td class="text-center" colspan="2">{{$format->empleado->name}}</td>
        </tr>
        <tr>
            <th>Ítem</th>
