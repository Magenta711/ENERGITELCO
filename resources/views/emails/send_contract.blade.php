                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            (4) 2307276<br>CALLE 48B NRO 66-65 MEDELLIN ANT.</p>
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                ...
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        enlace en tu navegador: <a
                                                            href="{{ config('app.url') }}/guest/attach/document/{{ $token }}"
                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3869d4;">{{ config('app.url') }}/guest/attach/document/{{ $token }}</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
